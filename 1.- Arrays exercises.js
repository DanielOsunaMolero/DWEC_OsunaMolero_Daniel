...
let arrayciudades = ["madrid", "barcelona" , "bilbao", "valencia"];
console.log(arrayciudades[0],arrayciudades[3]);
...
console.log(arraydias[arraydias.length - 1]);
...
let frutas=["manzana" , "pera" , "albaricoque" , "melocoton", "cerezas"];
frutas.splice(2,3);
console.log(frutas[1]);
//Exercise 4: Insert two elements at position 2 in a three-element array using splice().
let arraytres = [1,2,3];
arraytres.splice(0,1, "si");
arraytres.splice(0,1, "no");
